...
namespace HNTAS.Core.Api.Models
{
    public class Counter
    {
        ...
        /// This will be used as the '_id' in MongoDB, e.g., "orgId_sequence", "userId_sequence".
        /// </summary>
        [BsonId] // Specifies that this property should be used as the document's _id in MongoDB
        ...
        /// </summary>
        [BsonElement("sequence_value")] // Specifies the field name in MongoDB
